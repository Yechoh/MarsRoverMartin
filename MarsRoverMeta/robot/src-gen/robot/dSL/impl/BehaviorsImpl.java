 ...
 * </p>
 * <ul>
 *   <li>{@link robot.dSL.impl.BehaviorsImpl#getName <em>Name</em>}</li>
 *   <li>{@link robot.dSL.impl.BehaviorsImpl#getSensorExpression <em>Sensor Expression</em>}</li>
 *   <li>{@link robot.dSL.impl.BehaviorsImpl#getActionlist <em>Actionlist</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BehaviorsImpl extends MinimalEObjectImpl.Container implements Behaviors
{
  ...
  {
    return DSLPackage.Literals.BEHAVIORS;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DSLPackage.BEHAVIORS__NAME, oldName, name));
  }
  ...
  public NotificationChain basicSetSensorExpression(Expression newSensorExpression, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DSLPackage.BEHAVIORS__SENSOR_EXPRESSION, oldSensorExpression, newSensorExpression);
  ...
  public void setSensorExpression(Expression newSensorExpression)
  {
    if (newSensorExpression != sensorExpression)
    {
      ...
      if (sensorExpression != null)
        msgs = ((InternalEObject)sensorExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DSLPackage.BEHAVIORS__SENSOR_EXPRESSION, null, msgs);
      if (newSensorExpression != null)
        msgs = ((InternalEObject)newSensorExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DSLPackage.BEHAVIORS__SENSOR_EXPRESSION, null, msgs);
      msgs = basicSetSensorExpression(newSensorExpression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DSLPackage.BEHAVIORS__SENSOR_EXPRESSION, newSensorExpression, newSensorExpression));
  }
  ...
  public EList<Actions> getActionlist()
  {
    if (actionlist == null)
    {
      actionlist = new EObjectContainmentEList<Actions>(Actions.class, this, DSLPackage.BEHAVIORS__ACTIONLIST);
    }
    return actionlist;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DSLPackage.BEHAVIORS__SENSOR_EXPRESSION:
        return basicSetSensorExpression(null, msgs);
      case DSLPackage.BEHAVIORS__ACTIONLIST:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DSLPackage.BEHAVIORS__NAME:
        return getName();
      case DSLPackage.BEHAVIORS__SENSOR_EXPRESSION:
