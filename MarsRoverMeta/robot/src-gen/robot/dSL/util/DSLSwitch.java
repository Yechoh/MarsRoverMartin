...
public class DSLSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        RobotBehavior robotBehavior = (RobotBehavior)theEObject;
        T result = caseRobotBehavior(robotBehavior);
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Robot Behavior</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Robot Behavior</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseRobotBehavior(RobotBehavior object)
  {
    return null;
  }
