...
public class SlaveGenerator {
  public static String MainToText(final RobotBehavior behavior) {
  ...
  public static String ModelToText(final RobotBehavior behavior) {
    StringConcatenation _builder = new StringConcatenation();
  ...
  public static String GetMesageToText(final RobotBehavior behavior) {
    StringConcatenation _builder = new StringConcatenation();
  ...
  public static String ReadSensorsToText(final RobotBehavior behavior) {
    StringConcatenation _builder = new StringConcatenation();
