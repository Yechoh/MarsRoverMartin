...
public class DSLAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected DSLSwitch<Adapter> modelSwitch =
    ...
    {
      @Override
      public Adapter caseRobotBehavior(RobotBehavior object)
      {
        return createRobotBehaviorAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link robot.dSL.RobotBehavior <em>Robot Behavior</em>}'.
   * <!-- begin-user-doc -->
   ...
   * @generated
   */
  public Adapter createRobotBehaviorAdapter()
  {
    return null;
  }

  /**
   * Creates a new adapter for an object of class '{@link robot.dSL.Behaviors <em>Behaviors</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
