...
public class DSLPackageImpl extends EPackageImpl implements DSLPackage
{
   ...
   * @generated
   */
  private EClass robotBehaviorEClass = null;
   ...
   * @generated
   */
  public EClass getRobotBehavior()
  {
    return robotBehaviorEClass;
  }
   ...
   * @generated
   */
  public EReference getRobotBehavior_Behaviorlist()
  {
    return (EReference)robotBehaviorEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EAttribute getBehaviors_Name()
  {
    return (EAttribute)behaviorsEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getBehaviors_SensorExpression()
  {
    return (EReference)behaviorsEClass.getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EReference getBehaviors_Actionlist()
  {
    return (EReference)behaviorsEClass.getEStructuralFeatures().get(2);
  }
  ...
  public void createPackageContents()
  {
    ...
    robotBehaviorEClass = createEClass(ROBOT_BEHAVIOR);
    createEReference(robotBehaviorEClass, ROBOT_BEHAVIOR__BEHAVIORLIST);

    behaviorsEClass = createEClass(BEHAVIORS);
    createEAttribute(behaviorsEClass, BEHAVIORS__NAME);
    createEReference(behaviorsEClass, BEHAVIORS__SENSOR_EXPRESSION);
    createEReference(behaviorsEClass, BEHAVIORS__ACTIONLIST);
  ...
  public void initializePackageContents()
  {
    ...
    initEClass(robotBehaviorEClass, RobotBehavior.class, "RobotBehavior", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getRobotBehavior_Behaviorlist(), this.getBehaviors(), null, "behaviorlist", null, 0, -1, RobotBehavior.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(behaviorsEClass, Behaviors.class, "Behaviors", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getBehaviors_Name(), ecorePackage.getEString(), "name", null, 0, 1, Behaviors.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getBehaviors_SensorExpression(), this.getExpression(), null, "sensorExpression", null, 0, 1, Behaviors.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getBehaviors_Actionlist(), this.getActions(), null, "actionlist", null, 0, -1, Behaviors.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
