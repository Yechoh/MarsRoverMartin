...
public class Auxiliary {
  public static List<Behaviors> getBehaviors(final RobotBehavior root) {
    List<Behaviors> behaviorslist = new ArrayList<Behaviors>();
    EList<Behaviors> _behaviorlist = root.getBehaviorlist();
    for (final Behaviors t : _behaviorlist) {
      behaviorslist.add(t);
    }
